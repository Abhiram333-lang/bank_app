        ...
        <div className="bg-emerald-400 rounded-lg p-6 sm:p-8 w-full max-w-[400px] relative">
          ...
          <div className="flex justify-center">
            <button
              onClick={handleLogin}
              disabled={loading}
              className="font-semibold bg-gray-100 rounded-full px-10 py-2 hover:bg-blue-400 active:scale-90 transition-transform mb-4 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          {errorMsg && (
            <p className="text-red-700 text-sm text-center font-medium mb-3">
              {errorMsg}
            </p>
          )}
